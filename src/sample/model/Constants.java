...
public class Constants {
    ...
    static final String COLUMN_PRODUCT_COLOR_ID = "color_id";
    static final String COLUMN_PRODUCT_CATEGORY_ID = "category_id";
    static final String COLUMN_PRODUCT_BRAND_ID = "brand_id";
    private static final String COLUMN_PRODUCT_COLOR_NAME = "color_name";
    private static final String COLUMN_PRODUCT_CATEGORY_NAME = "category_name";
    private static final String COLUMN_PRODUCT_BRAND_NAME = "brand_name";
    ...
    static final int INDEX_PRODUCT_IN_STOCK = 5;
    static final int INDEX_PRODUCT_COLOR_ID = 6;
    static final int INDEX_PRODUCT_CATEGORY_ID = 7;
    static final int INDEX_PRODUCT_BRAND_ID = 8;
    static final int INDEX_PRODUCT_COLOR_NAME = 9;
    static final int INDEX_PRODUCT_CATEGORY_NAME = 10;
    static final int INDEX_PRODUCT_BRAND_NAME = 11;
    ...
    static final int INDEX_CATEGORY_ID = 1;
    ...
    static final String COLUMN_COLOR_ID = "_id";
    static final String COLUMN_COLOR_NAME = "name";

    public static final int INDEX_COLOR_ID = 1;
    public static final int INDEX_COLOR_NAME = 2;
    ...
    static final String QUERY_PRODUCTS = "SELECT " + PRODUCTS_TABLE + "." + COLUMN_PRODUCT_ID + ", " + PRODUCTS_TABLE + "." + COLUMN_PRODUCT_NAME + ", " +
            PRODUCTS_TABLE + "." + COLUMN_PRODUCT_PRICE + ", " +
            PRODUCTS_TABLE + "." + COLUMN_PRODUCT_DESCRIPTION + ", " + PRODUCTS_TABLE + "." + COLUMN_PRODUCT_IN_STOCK + ", " +
            PRODUCTS_TABLE + "." + COLUMN_PRODUCT_COLOR_ID + ", " +
            PRODUCTS_TABLE + "." + COLUMN_PRODUCT_CATEGORY_ID + ", " +
            PRODUCTS_TABLE + "." + COLUMN_PRODUCT_BRAND_ID + ", " +
            COLORS_TABLE + "." + COLUMN_COLOR_NAME + " AS " + COLUMN_PRODUCT_COLOR_NAME + ", " +
            ...
            " FROM (((" + PRODUCTS_TABLE +
            " INNER JOIN " + COLORS_TABLE + " ON " + PRODUCTS_TABLE + "." + COLUMN_PRODUCT_COLOR_ID + " = " + COLORS_TABLE + "." + COLUMN_COLOR_ID + ")" +
    ...
    static final String QUERY_BRANDS = "SELECT * FROM " + BRANDS_TABLE;
    static final String QUERY_COLORS = "SELECT * FROM " + COLORS_TABLE;

    static final String QUERY_SORT_BY_COLOR_NAME = " ORDER BY " + COLORS_TABLE + "." + COLUMN_COLOR_NAME + " COLLATE NOCASE ";
    ...
    public static final String QUERY_COLOR = "SELECT " + COLUMN_COLOR_ID + " FROM " +
            COLORS_TABLE + " WHERE " + COLUMN_COLOR_NAME + " = ?";

    public static final String QUERY_CATEGORY = "SELECT " + COLUMN_CATEGORY_ID + " FROM " +
            CATEGORIES_TABLE + " WHERE " + COLUMN_CATEGORY_NAME + " = ?";

    public static final String INSERT_COLOR = INSERT + BRANDS_TABLE +
    ...
    public static final String INSERT_PRODUCT = INSERT + PRODUCTS_TABLE +
            "(" + COLUMN_PRODUCT_NAME + ", " + COLUMN_PRODUCT_PRICE + ", " + COLUMN_PRODUCT_DESCRIPTION + ", " + COLUMN_PRODUCT_IN_STOCK + ", " +
            COLUMN_PRODUCT_COLOR_NAME + ", " + COLUMN_PRODUCT_CATEGORY_NAME + ", " + COLUMN_PRODUCT_BRAND_NAME +
            ") VALUES(?, ?, ?, ?, ?, ?, ?)";
}
